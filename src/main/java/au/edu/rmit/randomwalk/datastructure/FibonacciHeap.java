package au.edu.rmit.randomwalk.datastructure;
...
public final class FibonacciHeap<T> {
    ...
    public Entry<T> dequeueMin() {
         ...
         * then set mMin to candidatePoint somewhere in that list.
         */
    ...
    private void cutNode(Entry<T> entry) {
         ...
         * we need to rewrite that pointer to candidatePoint to some arbitrary other
         * child.
         */
